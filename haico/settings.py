...
STATIC_INFOSCREEN_FILES_FOLDER = "infoscreen-static"
STATIC_INFOSCREEN_URL = f'/{STATIC_INFOSCREEN_FILES_FOLDER}/'
STATIC_INFOSCREEN_ROOT = STATIC_INFOSCREEN_FILES_FOLDER
